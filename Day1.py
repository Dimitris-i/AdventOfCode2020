...
def findEntriesSum2020(array):
    '''
    Brute force solution for finding the sum of 
    two numbers in an array totaling to 2020.

    Return: The number's product
    '''
...
def findThreeEntriesSum2020(array):
    '''
    Brute force solution for finding the sum of 
    there numbers in an array totaling to 2020.
...
def findThreeEntriesSum2020Dict(array):
    '''
    O(n^2) solution of finding three numbers that sum up to 
    2020 
    
    Return: Their Product
    '''
    for i in range(0,len(array)):
        nums = findEntriesSum2020Dict(2020-array[i], array)
        if nums:
            print(array[i])
            return nums * array[i]
...
def findEntriesSum2020Dict(target, array):
    '''
    O(n) solution of finding two numbers that sum up to 2020
    '''
    entries = {}
    for entry in array:
        if entry in entries:
